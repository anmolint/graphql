...
const resolvers = {
    ...
    Mutation:{
        registeruser: async(_,{username,password,confpassword,email,firstname,lastname}) =>{
            if(password!==confpassword){return {status:'password and confirm passwords do not match'}}
